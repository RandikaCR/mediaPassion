        ...
        <div class="padding-global is-tiny">
            <div class="home-grid_component">
                ...
                >
                    ...
                    <div
                        style="-webkit-transform: translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0)
                        ...
                        <img src="{{ asset('assets/common/images/FACES-01.jpg') }}" loading="lazy" alt="" class="home-grid_member _1" />
                    ...
                    <div style="-webkit-transform: translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0)
                                            rotateZ(0deg) skew(0, 0);
                                        -moz-transform: translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0)
                                            rotateZ(0deg) skew(0, 0);
                                        -ms-transform: translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0)
                                            rotateZ(0deg) skew(0, 0);
                                        transform: translate3d(0, 0, 0) scale3d(1, 1, 1) rotateX(0) rotateY(0)
                                            rotateZ(0deg) skew(0, 0);" class="home-grid_circle-2">
