...
@section('content')
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">All Designations</h4>
        ...
        <div class="col-md-4">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1"><span class="me-1">Create New</span><span>Designations</span></h4>
                    <div class="flex-shrink-0">
                    </div>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-sm-12 mb-2">
                            <div>
                                <label for="name-input" class="form-label">Designations *</label>
                ...
                <div class="card-footer">
                    <div class="row">
                        <div class="col-sm-12 d-flex justify-content-end">
                            ...
                            <a href="{{ url('/admin/designations') }}" class="btn btn-outline-dark waves-effect waves-light me-2"><i class="mdi mdi-restore me-1"></i>Reset</a>
    ...
    <script>
        $(document).ready(function (){
            ...
            $('.save-this-form').on('click', function (){
                ...
                $url = "{{ route('backend.designations.store') }}";
                ...
                if($name == ''){
                    ...
                    $alert = alertDanger('Designation can not be empty!', 'Error');
            ...
            $('.table').on('click', '.edit', function (){
                $id = $(this).data('id');
                $url = "{{ route('backend.designations.get') }}";
                $.ajax({
                    url: $url,
                    dataType: 'json',
                    data: {
                    ...
                    success: function ($res, $textStatus, $jqXHR) {
                        $('#edit-id').val($res.id);
                        $('#name-input').val($res.designation);
                        $('#form-alert-area').html('');
            ...
            $('.table').on('change', '.status', function (){
                $id = $(this).data('id');
                $url = "{{ route('backend.designations.status') }}";
                $rowId = '#row-' + $id;
                $.ajax({
                    url: $url,
                    dataType: 'json',
