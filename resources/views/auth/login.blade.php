                    ...
                    <div class="text-center mt-sm-5 mb-4 text-white-50">
                        <div>
                            <a href="{{ url('/') }}" class="d-inline-block auth-logo">
                                <img src="{{ asset('assets/common/images/media-passion-logo.png') }}" alt="" height="60">
                            </a>
                        </div>
                        <p class="mt-3 fs-15 fw-medium">Media Passion Admin System</p>
                    </div>
                </div>
            </div>
            <!-- end row -->
                    ...
                    <div class="card mt-4">
                        ...
                        <div class="card-body p-4">
                            <div class="text-center mt-2">
                                ...
                                <p class="text-muted">Sign in to continue to Media Passion Admin System.</p>
                            </div>
                            <div class="p-2 mt-4">
                                @if($errors->any())
                                <div class="row">
                                ...
                                <form action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" id="email" name="email" placeholder="Enter Email Address" value="su@test.com">
                                    </div>
